...
Sopra Steria Group, per ADR-2607110300 -- a read-only reference archive.
As part of a fourth 10-repo validation batch extending the
...
- **Company**: Sopra Steria Group, LEI 96950020QIOHAAK9V551, website
  `https://www.soprasteria.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url
  `https://www.soprasteria.com/footer/terms-of-use`, retrieved-at
