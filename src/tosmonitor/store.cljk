(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Sopra Steria Group, LEI
  96950020QIOHAAK9V551) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "Sopra Steria Group"
   :website    "https://www.soprasteria.com"})

(def ^:private demo-full-text
  "Terms of Use\nBy accessing this website you agree to these Terms of Use. The content of this site is provided by Sopra Steria Group, a European leader in digital and IT consulting services, for informational purposes only and is subject to change without notice. These Terms are governed by the laws of France.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.soprasteria.com/footer/terms-of-use"
